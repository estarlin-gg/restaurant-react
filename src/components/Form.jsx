...
export const Select = () => {
  return (
    <select className=" shadow block appearance-none w-full  px-4 py-2 pr-8 rounded  leading-tight  focus:outline-blue-500">
    <option defaultValue value={null} >Elige una mesa</option>
